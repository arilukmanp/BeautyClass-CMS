...
<head>
	...
	<link rel="stylesheet" href="{{ asset('css/frontend/jquery.timepicker.css') }}">
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			...
			<img src="{{ asset('img/logo.png') }}" style="width: 60px; height: 65px; opacity: 0.9;" alt="">
			<span style="font-size: 30px; font-style: italic; color: #914264; font-weight: 600" class="ml-1">BeautyClass</span>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="blog.html" class="nav-link">Speakers</a></li>
	...
	<!-- END nav -->
 	...
 	<div class="container-fluid">
 		<div class="row">
	<div class="hero-wrap js-fullheight hero-image">
                                    ...
                                    <div class="container">
                                        <div class="row row-md-middle row-md-reverse">
                                            <div class="col-md-5  col-md-preffix-1 text-md-left">
                                                <h2>YOUR ESCAPE FROM EVERYDAY ROUTINE</h2>

                                                <p>Naillepo is a modern nail salon in Vancouver’s Kitsilano neighborhood providing an experience
                                                    with equal parts of style and service, without skimping on the details. We have all-natural,
                                                    organic body products, hard-to-find polish brands and colors, iPads at every seat, and a
                                                drink menu featuring fresh-pressed juices and hand-crafted coffees.</p>
                                            ...
                                            <div class="col-md-5 col-md-preffix-1">
                                                <div class="decorative-wrap-2 preffix-2 content-md-shift-up">
                                                    ...
                                                    <div class="image-wrap"><img width="459" height="651" src="https://livedemo00.template-help.com/wt_58329/images/page-1_img04.jpg" alt=""></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row row-md-middle">
                                            <div class="col-md-5 col-md-preffix-1 col-lg-4 text-md-right">
                                                <h2 class="text-uppercase">Classic Manicure</h2>

                                                <p>Done once a week, our manicure will stimulate nail growth and soften dry, dull skin. Includes
                                                hot soak, emphasis on cuticles, completed with massage and polish of your choice.</p>

                                                <div class="discount text-primary">— $20</div>
                                                <a href="#" class="btn btn-md btn-default">read more</a>
                                            </div>
                                            <div class="col-md-5 col-md-preffix-1">
                                                <div class="decorative-wrap-1 preffix-1">
                                                    <div class="decorative-border"></div>
                                                    <div class="image-wrap"><img width="414" height="405" src="https://livedemo00.template-help.com/wt_58329/images/page-1_img05.jpg" alt=""></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="container">
                                        <div class="row row-md-middle row-md-reverse">
                                            <div class="col-md-4 text-md-left">
                                                <h2 class="text-uppercase foreground-text preffix-4 relative">Spa Manicure </h2>

                                                <p>Our revitalizing spa manicure services include relaxing spa procedures, hands and arms
                                                massage as well as cuticles trim, nails clip and hand soak. </p>
                                            ...
                                            <div class="col-md-8">
                                                <div class="decorative-wrap-3 postfix-1 preffix-3">
                                                    <div class="decorative-border"></div>
                                                    <div class="decorative-background"></div>
                                                    <div class="image-wrap"><img width="706" height="407" src="https://livedemo00.template-help.com/wt_58329/images/page-1_img06.jpg" alt=""></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="product-slider owl-carousel ftco-animate">
						<div class="item">
							<div class="product">
								<a href="#" class="img-prod"><img class="img-fluid" src="{{ asset('img/product-1.jpg') }}" alt="Colorlib Template">
						...
						<div class="item">
							<div class="product">
								<a href="#" class="img-prod"><img class="img-fluid" src="{{ asset('css/product-2.jpg') }}" alt="Colorlib Template"></a>
								<div class="text pt-3 px-3">
									<h3><a href="#">Young Woman Wearing Dress</a></h3>
									<div class="d-flex">
										<div class="pricing">
						...
						<div class="item">
							<div class="product">
								<a href="#" class="img-prod"><img class="img-fluid" src="{{ asset('css/product-3.jpg') }}" alt="Colorlib Template"></a>
								<div class="text pt-3 px-3">
									<h3><a href="#">Young Woman Wearing Dress</a></h3>
									<div class="d-flex">
										<div class="pricing">
						...
						<div class="item">
							<div class="product">
								<a href="#" class="img-prod"><img class="img-fluid" src="{{ asset('css/product-4.jpg') }}" alt="Colorlib Template"></a>
								<div class="text pt-3 px-3">
									<h3><a href="#">Young Woman Wearing Dress</a></h3>
									<div class="d-flex">
										<div class="pricing">
						...
						<div class="item">
							<div class="product">
								<a href="#" class="img-prod"><img src="{{ asset('css/product-5.jpg') }}" alt="Colorlib Template">
									<span class="status">30%</span>
								</a>
								<div class="text pt-3 px-3">
									<h3><a href="#">Young Woman Wearing Dress</a></h3>
						...
						<div class="item">
							<div class="product">
								<a href="#" class="img-prod"><img src="{{ asset('css/product-6.jpg') }}" alt="Colorlib Template"></a>
								<div class="text pt-3 px-3">
									<h3><a href="#">Young Woman Wearing Dress</a></h3>
									<div class="d-flex">
										<div class="pricing">
	...
	<script src="{{ asset('js/frontend/bootstrap-datepicker.js') }}"></script>
