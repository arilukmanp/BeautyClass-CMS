				...
				@if($merchant->profile->photo != null)
					<div class="col-xs-12 col-md-12">
						<a href="" data-toggle="modal" data-target="#myModal" class="mx-auto thumbnail avatar-photo">
							<img src="{{ asset('storage/merchants/'.$merchant->profile->photo) }}" class="img-responsive" alt="Photo">
						</a>
					</div>
						...
						<div class="modal-dialog">
						  	<div class="modal-content">
								<div class="modal-body" style="padding-top:8px">
									...
									<img src="{{ asset('storage/merchants/'.$merchant->profile->photo) }}" class="img-responsive">
							  	</div>
							</div>
						</div>
					</div>
